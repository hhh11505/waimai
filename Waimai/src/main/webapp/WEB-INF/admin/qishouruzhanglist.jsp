                        ...
                        <div class="widget">
                            <div class="widget-content">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <c:forEach items="${qishouruzhanglist }" var="qishouruzhang">
                                        <tr>

                                            <td>${qishouruzhang.qid }</td>
                                            <td>${qishouruzhang.sjddbh }</td>
                                            <td>${qishouruzhang.sj }</td>
                                            <td>${qishouruzhang.yhpj }</td>
                                            <td>${qishouruzhang.dbsr }</td>
                                            <td>
