                        ...
                        <div class="widget">
                            <div class="widget-content">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <c:forEach items="${yonghuxinxilist }" var="yonghuxinxi">
                                        <tr>

                                            <td>${yonghuxinxi.bh }</td>
                                            <td>${yonghuxinxi.xm }</td>
                                            <td>${yonghuxinxi.xb }</td>
                                            <td>${yonghuxinxi.mm }</td>
                                            <td>${yonghuxinxi.sjhm }</td>

                                            <td>${yonghuxinxi.yx }</td>
                                            <td>${yonghuxinxi.szcs }</td>
                                            <td>${yonghuxinxi.zcsj }</td>
                                            <td>${yonghuxinxi.sfhy }</td>
                                            <td>${yonghuxinxi.hyjzrq }</td>
                                            <td>
