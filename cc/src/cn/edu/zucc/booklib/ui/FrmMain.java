...
import cn.edu.zucc.booklib.control.*;
...
public class FrmMain extends JFrame implements ActionListener {
    ...
    private JMenuItem  menuItem_PublisherManager=new JMenuItem("管理员信息");
	...
	public FrmMain(){
	 ...
	 //   JLabel label=new JLabel("您好!"+BeanManagerinfo.currentLoginMa.getMname());
	    //statusBar.add(label);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.menuItem_UserManager){
			FrmUserManager dlg=new FrmUserManager(this,"商家管理",true);
			dlg.setVisible(true);
		}
		else if(e.getSource()==this.menuItem_ReaderTypeManager){
			FrmReaderTypeManager dlg=new FrmReaderTypeManager(this,"用户管理",true);
			dlg.setVisible(true);
		}
		else if(e.getSource()==this.menuItem_ReaderManager){
			FrmReaderManager dlg=new FrmReaderManager(this,"骑手管理",true);
			dlg.setVisible(true);
		}
		else if(e.getSource()==this.menuItem_PublisherManager){
			FrmPublisherManager dlg=new FrmPublisherManager(this,"管理员管理",true);
			dlg.setVisible(true);
		}
