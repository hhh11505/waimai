...
import cn.edu.zucc.booklib.PersonPlanUtil;
import cn.edu.zucc.booklib.model.*;
import cn.edu.zucc.booklib.ui.FrmRegister;
...
public class FrmLogin extends JDialog implements ActionListener {
	...
	private Button btnRegister = new Button("×¢²á");
	...
	public void actionPerformed(ActionEvent e) {
		...
		MaManage sum=new MaManage();
			...
			String mpwd=new String(this.edtPwd.getPassword());
			try {
				BeanManagerinfo.currentLoginMa= sum.loadUser(mname, mpwd);
			} catch (BaseException e1) {
				JOptionPane.showMessageDialog(null, e1.getMessage(), "´íÎóÌáÊ¾",JOptionPane.ERROR_MESSAGE);
				return;
			}
